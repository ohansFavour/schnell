...
class Firstpage extends React.Component {
  ...
  render() {
    ...
    return (
      <StyledContainer className={`landing-page-container `}>
        <Carousel
          activeIndex={index}
          direction={direction}
        ...
        >
            ...
            <div className="content1">
              ...
              >
                ...
                <div className="schnell-content">
                  ...
                  LoRaWAN network.
                  <br />
                  We provide the infrastructure to support your solution,
                  allowing you to focus more on your use case.
                </div>
              </Animated>
            </div>
          </Carousel.Item>
          ...
          <Carousel.Item id="slide2">
            <div className="content2">
              ...
              >
                <div className="schnell-content">
                  Our single gateways can connect to your device up to 10km
                  away.
                </div>
              </Animated>
            </div>
